...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_error_handling = 13             /* error_handling  */
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* error_handling: ERROR  */
#line 24 "./files/simple_language.y"
                      { std::cout << "Syntax error: Invalid token." << std::endl; exit(EXIT_FAILURE); }
#line 1126 "y.tab.c"
    break;
