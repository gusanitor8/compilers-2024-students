...
class MiniLangListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MiniLangParser#declareFunction.
    def enterDeclareFunction(self, ctx:MiniLangParser.DeclareFunctionContext):
        pass

    # Exit a parse tree produced by MiniLangParser#declareFunction.
    def exitDeclareFunction(self, ctx:MiniLangParser.DeclareFunctionContext):
        pass
